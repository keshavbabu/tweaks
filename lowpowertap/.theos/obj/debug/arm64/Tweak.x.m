...
{Class _logos_class$_ungrouped$UIStatusBarWindow = objc_getClass("UIStatusBarWindow"); MSHookMessageEx(_logos_class$_ungrouped$UIStatusBarWindow, @selector(initWithFrame:), (IMP)&_logos_method$_ungrouped$UIStatusBarWindow$initWithFrame$, (IMP*)&_logos_orig$_ungrouped$UIStatusBarWindow$initWithFrame$);{ char _typeEncoding[1024]; unsigned int i = 0; _typeEncoding[i] = 'v'; i += 1; _typeEncoding[i] = '@'; i += 1; _typeEncoding[i] = ':'; i += 1; _typeEncoding[i] = '\0'; class_addMethod(_logos_class$_ungrouped$UIStatusBarWindow, @selector(toggleLowPowerMode), (IMP)&_logos_method$_ungrouped$UIStatusBarWindow$toggleLowPowerMode, _typeEncoding); }Class _logos_class$_ungrouped$UIStatusBarManager = objc_getClass("UIStatusBarManager"); { char _typeEncoding[1024]; unsigned int i = 0; _typeEncoding[i] = 'v'; i += 1; _typeEncoding[i] = '@'; i += 1; _typeEncoding[i] = ':'; i += 1; _typeEncoding[i] = '\0'; class_addMethod(_logos_class$_ungrouped$UIStatusBarManager, @selector(toggleLowPowerMode), (IMP)&_logos_method$_ungrouped$UIStatusBarManager$toggleLowPowerMode, _typeEncoding); }MSHookMessageEx(_logos_class$_ungrouped$UIStatusBarManager, @selector(handleTapAction:), (IMP)&_logos_method$_ungrouped$UIStatusBarManager$handleTapAction$, (IMP*)&_logos_orig$_ungrouped$UIStatusBarManager$handleTapAction$);} }
#line 50 "Tweak.x"
